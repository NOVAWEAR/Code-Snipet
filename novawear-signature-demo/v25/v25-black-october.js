(function(){
 ...
 function home(){
  ...
  s.innerHTML=`<div class="v25-black-head"><div><div class="v25-black-kicker">BLACK OCTOBER · 2026</div><h2>NEW<br>ICONS.</h2></div><p>Zwölf neue Heavyweight Backprint Pieces. 240 GSM, Oversized Fit und eine dunklere NOVAWEAR Bildwelt für den Oktober Drop.</p></div><div class="v26-cinematic-products"><img src="${CINEMATIC}" alt="NOVAWEAR Black October cinematic product presentation"><a class="v26-hit v26-hit-1" href="https://www.novawear.de/products/${DROP[0].h}" aria-label="GUARDIAN ansehen"></a><a class="v26-hit v26-hit-2" href="https://www.novawear.de/products/${DROP[1].h}" aria-label="ASCEND ansehen"></a><a class="v26-hit v26-hit-3" href="https://www.novawear.de/products/${DROP[2].h}" aria-label="SOVEREIGN ansehen"></a></div><div class="v25-black-grid v26-mobile-products">${DROP.slice(0,6).map(card).join('')}</div><div class="v25-black-footer"><p>12 neue Pieces · Black October 2026.</p><a href="black-october.html">VIEW ALL 12 →</a></div>`;
  trust?.after(s);
